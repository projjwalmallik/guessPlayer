    ...
    <nav className="flex justify-between items-center py-4 px-8 md:px-20 lg:px-60 bg-white text-gray-900">
      <div className="logo">
        <h1 className="text-3xl font-bold flex items-center">
          <Link to="/">
            <img
              src="https://img.icons8.com/external-yogi-aprelliyanto-detailed-outline-yogi-aprelliyanto/64/external-cricket-sport-and-game-yogi-aprelliyanto-detailed-outline-yogi-aprelliyanto.png"
              alt="CrickIt Logo"
              className="h-6 md:h-8 lg:h-10 mr-2"
            />{" "}
          </Link>
      ...
      <div className="links flex items-center gap-4 md:gap-8">
        ...
        <span>
          <Link to="/play" className="text-gray-900">
            Play
          </Link>
        </span>
        <span>
