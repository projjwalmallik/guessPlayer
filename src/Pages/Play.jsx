...
const Play = () => {
    ...
    const [player1, setplayer1] = useState({franchise: '', jerseyNumber: '', role: '', price: '', country: '', age: '', playerName: ''});
    const [player2, setplayer2] = useState({franchise: '', jerseyNumber: '', role: '', price: '', country: '', age: '', playerName: ''});
    const [player3, setplayer3] = useState({franchise: '', jerseyNumber: '', role: '', price: '', country: '', age: '', playerName: ''});
    const [player4, setplayer4] = useState({franchise: '', jerseyNumber: '', role: '', price: '', country: '', age: '', playerName: ''});
    ...
    const [HintLeft, setHintLeft] = useState();
    ...
    useEffect(() => {
        ...
        const storedLastStreakDate = JSON.parse(localStorage.getItem('lastStreakDate'));
      
      
        if (storedStreak && storedLastStreakDate) {
      
          setStreak(storedStreak);
      
          setLastStreakDate(new Date(storedLastStreakDate));
      ...
      useEffect(() => {
        ...
        updateLocalStorage('lastStreakDate', lastStreakDate);
      
      }, [streak, lastStreakDate]);

    const isYesterday = (currentDate, lastStreakDate) => {
        const yesterday = new Date();
        yesterday.setDate(yesterday.getDate() - 1);
        return lastStreakDate.getDate() === yesterday.getDate() && lastStreakDate.getMonth() === yesterday.getMonth() && lastStreakDate.getFullYear() === yesterday.getFullYear();
      };

    const updateStreak = () => {
        const currentDate = new Date();
      
        if (lastStreakDate === null || isYesterday(currentDate, lastStreakDate)) {
          setStreak(streak + 1);
